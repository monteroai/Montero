            ...
            >
              ...
              <div style={{ padding: '24px 20px' }}>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
                  {c.outcomes.map((o, j) => (
                    <li key={j} style={{ display: 'flex', gap: '10px', fontSize: '13px', color: 'var(--text-muted)', lineHeight: 1.6 }}>
                ...
                {c.link && (
                  <a href={c.link} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: '13px', fontWeight: 600, color: 'var(--gold)', paddingTop: '12px', borderTop: '1px solid var(--border)', display: 'block' }}>
                    {c.linkLabel} →
                  </a>
                )}
              </div>
